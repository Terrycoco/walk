...
//change the colors to whatever suits you

export const myColors = {
  deep: '#0F1B07', //15, 27, 7
  light: '#ffffff',
  green: '#5C821A',
  brightgreen: '#C6D166', //198, 209 , 102
  orange: '#fd8258',
  ltblue: '#128ba1',
  barelygreen: 'rgba(198, 209, 102, .2)',
  gray: 'rgba(15,27,7, .2)',
  lightgray: '#eee'
};

export const theme = {
 lightest: myColors.light,
 gray: myColors.gray,   
 ...
 highlight: myColors.barelygreen,
 disabled: myColors.lightgray
};

//any material-ui defaults on components can be changed here (more below)
export default getMuiTheme({
  ...
  textField: {
    ...
    floatingLabelColor: theme.primary1Color,
    disabledTextColor: theme.primary1Color,
    errorColor: myColors.orange,
    focusColor: theme.primary1Color,
   ...
   checkbox: {
      boxColor: theme.primary1Color,
      checkedColor: theme.primary1Color,
      requiredColor: theme.primary1Color,
